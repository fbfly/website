...
// Bare Template address in aragonPM (xDai)
const BARE_TEMPLATE_ADDRESS = '0xf66eb91773f7c51dc65b31259952e3bd98cb1207'
const MINIME_FACTORY_ADDRESS = '0xf7d36d4d46cda364edc85e5561450183469484c5'
...
const FINANCE_IMPL_ADDRESS = '0x18652fc5bf0c5e8f7e6ddb20acdec8fa13187ab3'
...
const TOKEN_MANAGER_IMPL_ADDRESS = '0xe071b2aae56e6143edc922cc5d48d1dabbdb50e6'
...
const VAULT_IMPL_ADDRESS = '0xa35531f41f577f8817be517f84e5f16ed250bebc'
...
const VOTING_IMPL_ADDRESS = '0xd4856cd82cb507b2691bcc3f02d8939671a800c0'
...
export default async function createDao(tokenName, tokenSymbol) {
  console.log('Started...')
  ...
  console.log(minimeContract.address)
  ...
  const tokenManagerContractAddress = await getAppAddress(
    ...
    .then()
    .catch(() => {
      throw new Error('Error getting finance app address')
    })
  ...
  const changeControllerTx = await minimeContract
    .changeController(tokenManagerContractAddress, {
      gasLimit: 10000000,
      gasPrice: 1000000000,
    })
    .then(
  ...
  console.log('Token minted to', dictatorAccount)
  //
