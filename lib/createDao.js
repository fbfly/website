...
export default async function createDao(torusProvider) {
  ...
  const torusAccount = '0x419a443899Fa8401Bd10dF6D18863d66b36ec320'
  ...
  console.log(tokenManagerContract)

  await tokenManagerContract.mint(dictatorAccount, '50', {
    gasLimit: 150000,
    gasPrice: 9000000000,
  })
  ...
  console.log('Voting app installed')
  ...
  console.log('Finance app installed')
  ...
  await aclContract.grantPermission(
    ...
    tokenManagerContractAddress,
    TOKEN_MANAGER_MINT_ROLE,
    { gasLimit: 150000, gasPrice: 9000000000 },
  )
